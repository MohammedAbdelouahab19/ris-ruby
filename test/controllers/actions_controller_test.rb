...
class ActionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create action" do
    assert_difference("Action.count") do
      post actions_url, params: { action: { code: @action.code, name: @action.name } }, as: :json
    end
  ...
  test "should update action" do
    patch action_url(@action), params: { action: { code: @action.code, name: @action.name } }, as: :json
    assert_response :success
  end
