...
class NursesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create nurse" do
    assert_difference("Nurse.count") do
      post nurses_url, params: { nurse: { first_name: @nurse.first_name, last_name: @nurse.last_name } }, as: :json
    end
  ...
  test "should update nurse" do
    patch nurse_url(@nurse), params: { nurse: { first_name: @nurse.first_name, last_name: @nurse.last_name } }, as: :json
    assert_response :success
  end
